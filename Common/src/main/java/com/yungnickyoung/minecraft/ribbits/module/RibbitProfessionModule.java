...
public class RibbitProfessionModule {
    ...
    public static final RibbitProfession NITWIT = register("nitwit", "geo/nitwit_ribbit");
    public static final RibbitProfession GARDENER = register("gardener", "geo/gardener_ribbit");
    public static final RibbitProfession SORCERER = register("sorcerer", "geo/sorcerer_ribbit");
    public static final RibbitProfession FISHERMAN = register("fisherman", "geo/fisherman_ribbit");
    public static final RibbitProfession MERCHANT = register("merchant", "geo/merchant_ribbit");
